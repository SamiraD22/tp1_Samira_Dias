...
public class TP1 {
        ...
        if (nomeAlunos[0] == null){
            ...
            for (int i = 0; i <= nomeAlunos.length -1; i++){
                if (nomeAlunos[i] != null){
                    int codigo = i + 1;
                    System.out.println(" " +codigo+ "Aluno: " + nomeAlunos[i]);
                }
            }
        }
        interC.showMsg(" ");
        ...
        if (nomeAlunos != null){
            if (tela > 0){
                ...
                for (String aluno : nomeAlunos){
                    ...
                    if (n >= tela){
                    interC.showMsg("pagina seguinte");
                        System.out.println("                  \n");
                        n= 0;
                    }
                }
    ...
    private static void calcularMaxMinAvg() {
        ...
        notaAvg = soma / cont;
        System.out.println("nota maxima e: " + notaMax);
        System.out.println("nota minima e: " + notaMin);
        System.out.println("media das notas e: " + notaAvg);
        interC.showMsg("");
        }
    ...
    public static void mostraResumo() {
        ...
        System.out.println("Numero de alunos com nota inferior a media: "+Notamax);
        System.out.println("Numero de alunos com nota superior a media: "+Notamin);
        interC.showMsg("");
    ...
    public static void mostrarPauta() {
        ...
        if (nomeAlunos != null){
            int lidos = 0;
            int cont = 1;
            System.out.println("codigo" + "estudantes");
            for (int i = 0; i <= nomeAlunos.length-1; i++){
                if (nomeAlunos [i] == null)
                    break;
                lidos += 1;
                System.out.println(" " +cont++ + " " +nomeAlunos[i] + " " + "nota " + notasAlunos[i]);
                if (lidos >= 10){
                    System.out.println("  \n");
                    lidos = 0;
                }
        ...
        if (nomeAlunos[0]==null){
            ...
            for (int i=0; i <= nomeAlunos.length -1; i++) {
                ...
                if(nome.equalsIgnoreCase(nomeAlunos[i])) {
                    ...
                    System.out.println(" Aluno nmr "+ n + " "+ nomeAlunos[i]);
                }
            }
        }
        interC.showMsg("");
         ...
         if (nomeAlunos[0]==null){
             ...
             for (int i=0; i <= nomeAlunos.length -1; i++) {
                 ...
                 if(nota == notasAlunos[i]) {
                     System.out.println("aluno codigo" + n + " " + nomeAlunos[i] + " , nota: " + notasAlunos[i]);
